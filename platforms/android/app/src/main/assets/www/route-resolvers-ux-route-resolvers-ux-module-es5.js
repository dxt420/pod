(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["route-resolvers-ux-route-resolvers-ux-module"], {
        ...
        if (this.route && this.route.data) {
          ...
          if (dataObservable) {
            dataObservable.subscribe(observableValue => {
              const pageData = observableValue['data']; // tslint:disable-next-line:max-line-length
        ...
        if (this.route && this.route.data) {
          ...
          if (promiseObservable) {
            promiseObservable.subscribe(promiseValue => {
              ...
              if (dataObservable) {
                dataObservable.subscribe(observableValue => {
                  const pageData = observableValue; // tslint:disable-next-line:max-line-length
  ...
  function srcAppShowcaseRouteResolversUxNonBlockingResolversNonBlockingResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let NonBlockingResolver = class NonBlockingResolver {
      ...
      resolve() {
        // Base Observable (where we get data from)
        const dataObservable = this.showcaseService.getDataSourceWithDelay(); // NON-BLOCKING RESOLVERS
