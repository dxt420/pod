(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[2], {
  ...
  function node_modulesIonicCoreDistEsmIonActionSheetIosEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    const iosEnterAnimation = (AnimationC, baseEl) => {
      ...
      const ani = baseAnimation.addElement(baseEl).easing('cubic-bezier(.36,.66,.04,1)').duration(400).add(backdropAnimation).add(wrapperAnimation);
    ...
    const iosLeaveAnimation = (AnimationC, baseEl) => {
      ...
      const ani = baseAnimation.addElement(baseEl).easing('cubic-bezier(.36,.66,.04,1)').duration(450).add(backdropAnimation).add(wrapperAnimation);
      return Promise.resolve(ani);
    };
    /**
    ...
    class ActionSheet {
      ...
      render() {
        ...
        return Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["H"], {
        ...
        }, this.header, this.subHeader && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "action-sheet-sub-title"
        }, this.subHeader)), buttons.map(b => Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", {
          type: "button",
        ...
        }), b.text), mode === 'md' && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", null)))), cancelButton && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          ...
          class: "action-sheet-button-inner"
        }, cancelButton.icon && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", {
