(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tabs-tabs-module"], {
  ...
  function srcAppTabsStylesTabsPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "ion-tab-button {\n  --color: var(--ion-color-medium-shade);\n  --color-selected: var(--ion-color-dark);\n}\n\nion-tab-bar {\n  --background:#060606;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    const routes = [{
      ...
      children: [{
        ...
        children: [{
          ...
          "./src/app/fashion/listing/fashion-listing.module.ts")).then(m => m.FashionListingPageModule)
        }, {
          ...
          "./src/app/fashion/details/fashion-details.module.ts")).then(m => m.FashionDetailsPageModule)
        }, {
          path: 'food',
          loadChildren: () => Promise.all(
          ...
          "./src/app/food/listing/food-listing.module.ts")).then(m => m.FoodListingPageModule)
        }, {
          path: 'food/:productId',
          loadChildren: () => Promise.all(
          ...
          "./src/app/food/details/food-details.module.ts")).then(m => m.FoodDetailsPageModule)
        }, {
          path: 'travel',
          loadChildren: () => Promise.all(
          ...
          "./src/app/travel/listing/travel-listing.module.ts")).then(m => m.TravelListingPageModule)
        }, {
          ...
          "./src/app/travel/details/travel-details.module.ts")).then(m => m.TravelDetailsPageModule)
        }, {
          path: 'deals',
          loadChildren: () => Promise.all(
          ...
          "./src/app/deals/listing/deals-listing.module.ts")).then(m => m.DealsListingPageModule)
        }, {
          ...
          "./src/app/deals/details/deals-details.module.ts")).then(m => m.DealsDetailsPageModule)
        }, {
          path: 'real-state',
          loadChildren: () => Promise.all(
          /*! import() | real-state-listing-real-state-listing-module */
          [__webpack_require__.e("common"), __webpack_require__.e("real-state-listing-real-state-listing-module")]).then(__webpack_require__.bind(null,
          /*! ../real-state/listing/real-state-listing.module */
          "./src/app/real-state/listing/real-state-listing.module.ts")).then(m => m.RealStateListingPageModule)
        }, {
          path: 'real-state/:productId',
          loadChildren: () => Promise.all(
          /*! import() | real-state-details-real-state-details-module */
          [__webpack_require__.e("common"), __webpack_require__.e("real-state-details-real-state-details-module")]).then(__webpack_require__.bind(null,
          /*! ../real-state/details/real-state-details.module */
          "./src/app/real-state/details/real-state-details.module.ts")).then(m => m.RealStateDetailsPageModule)
        }]
      }, {
        path: 'user',
        children: [{
          ...
          loadChildren: () => Promise.all(
          /*! import() | user-profile-playlist-module */
          [__webpack_require__.e("common"), __webpack_require__.e("user-profile-playlist-module")]).then(__webpack_require__.bind(null,
          /*! ../user/profile/playlist.module */
          "./src/app/user/profile/playlist.module.ts")).then(m => m.PlaylistPageModule)
        }, {
          path: 'artists',
          loadChildren: () => Promise.all(
          /*! import() | artists-notifications-module */
          [__webpack_require__.e("common"), __webpack_require__.e("artists-notifications-module")]).then(__webpack_require__.bind(null,
          /*! ../artists/notifications.module */
          "./src/app/artists/notifications.module.ts")).then(m => m.NotificationsPageModule)
        }, {
          path: 'album',
          loadChildren: () => Promise.all(
          /*! import() | album-profile-user-profile-module */
          [__webpack_require__.e("common"), __webpack_require__.e("album-profile-user-profile-module")]).then(__webpack_require__.bind(null,
          /*! ../album/profile/user-profile.module */
          "./src/app/album/profile/user-profile.module.ts")).then(m => m.UserProfilePageModule)
        }]
      }, {
        path: 'search',
        children: [{
          ...
          "user-friends-user-friends-module").then(__webpack_require__.bind(null,
          /*! ../user/friends/user-friends.module */
          "./src/app/user/friends/user-friends.module.ts")).then(m => m.UserFriendsPageModule)
        }]
      }, {
        path: 'library',
        children: [{
          path: '',
          loadChildren: () => Promise.all(
          /*! import() | library-profile-user-profile-module */
          [__webpack_require__.e("common"), __webpack_require__.e("library-profile-user-profile-module")]).then(__webpack_require__.bind(null,
          /*! ../library/profile/user-profile.module */
          "./src/app/library/profile/user-profile.module.ts")).then(m => m.UserProfilePageModule)
        }]
      }, {
        path: 'notifications',
        children: [{
          ...
          "./src/app/notifications/notifications.module.ts")).then(m => m.NotificationsPageModule)
        }]
      }, {
        path: 'artist',
        children: [{
          path: '',
          loadChildren: () => __webpack_require__.e(
          /*! import() | artist-details-places-details-module */
          "artist-details-places-details-module").then(__webpack_require__.bind(null,
          /*! ../artist/details/places-details.module */
          "./src/app/artist/details/places-details.module.ts")).then(m => m.PlacesDetailsPageModule)
        }]
      }, {
        path: 'musicplayer',
        children: [{
          path: '',
          loadChildren: () => __webpack_require__.e(
          /*! import() | musicplayer-musicplayer-module */
          "musicplayer-musicplayer-module").then(__webpack_require__.bind(null,
          /*! ../musicplayer/musicplayer.module */
          "./src/app/musicplayer/musicplayer.module.ts")).then(m => m.MusicplayerPageModule)
        }]
      }]
    }, // /app/ redirect
    {
