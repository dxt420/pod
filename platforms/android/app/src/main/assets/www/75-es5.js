(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[75], {
  ...
  function node_modulesIonicCoreDistEsmIonToastMdEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    const iosEnterAnimation = (AnimationC, baseEl, position) => {
      ...
      return Promise.resolve(baseAnimation.addElement(hostEl).easing('cubic-bezier(.155,1.105,.295,1.12)').duration(400).add(wrapperAnimation));
    };
    /**
    ...
    const iosLeaveAnimation = (AnimationC, baseEl, position) => {
      ...
      return Promise.resolve(baseAnimation.addElement(hostEl).easing('cubic-bezier(.36,.66,.04,1)').duration(300).add(wrapperAnimation));
    };
    /**
    ...
    const mdEnterAnimation = (AnimationC, baseEl, position) => {
      ...
      return Promise.resolve(baseAnimation.addElement(hostEl).easing('cubic-bezier(.36,.66,.04,1)').duration(400).add(wrapperAnimation));
    };
    /**
    ...
    class Toast {
      ...
      renderButtons(buttons, side) {
        ...
        }, buttons.map(b => Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", {
          type: "button",
          class: buttonClass(b),
          tabIndex: 0,
        ...
        }, b.icon && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", {
          icon: b.icon,
          slot: b.text === undefined ? 'icon-only' : undefined,
          class: "toast-icon"
        }), b.text), mode === 'md' && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", {
      ...
      render() {
        ...
        return Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["H"], {
          ...
          class: Object.assign({
            [mode]: true
          }, Object(_chunk_353a032e_js__WEBPACK_IMPORTED_MODULE_3__["c"])(this.color), Object(_chunk_353a032e_js__WEBPACK_IMPORTED_MODULE_3__["g"])(this.cssClass), {
        ...
        }, this.renderButtons(startButtons, 'start'), Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "toast-content"
        }, this.header !== undefined && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "toast-header"
        }, this.header), this.message !== undefined && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
          class: "toast-message",
