(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[38], {
  ...
  function node_modulesIonicCoreDistEsmIonMenu_4IosEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _index_f4f18d97_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./index-f4f18d97.js */
    ...
    class Menu {
      constructor(hostRef) {
        ...
        this.lastOnEnd = 0;
        this.blocker = _index_f4f18d97_js__WEBPACK_IMPORTED_MODULE_4__["GESTURE_CONTROLLER"].createBlocker({
          disableScroll: true
        });
      ...
      async componentWillLoad() {
        ...
        /*! ./index-f4f18d97.js */
        "./node_modules/@ionic/core/dist/esm/index-f4f18d97.js"))).createGesture({
          el: document,
      ...
      onEnd(detail) {
        ...
        this.animation.onFinish(() => this.afterAnimation(shouldOpen), {
      ...
      render() {
        ...
        }, Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)), Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-backdrop", {
    ...
    const MENU_CONTENT_OPEN = 'menu-content-open'; // Get the menu controller element
    ...
    class MenuButton {
      ...
      render() {
        ...
        return Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["H"], {
          ...
          class: Object.assign({
            [mode]: true
          }, Object(_chunk_353a032e_js__WEBPACK_IMPORTED_MODULE_2__["c"])(color), {
            'button': true,
        ...
        }, Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", Object.assign({}, attrs, {
          disabled: this.disabled,
          class: "button-native"
        }), Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null, Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", {
          icon: menuIcon,
          mode: mode,
          lazy: false
        })), mode === 'md' && Object(_chunk_d0403a2f_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", {
          type: "unbounded"
        })));
      }
    ...
    const menuOverlayAnimation = (AnimationC, _, menu) => {
      ...
      const menuAnimation = new AnimationC().addElement(menu.menuInnerEl).fromTo('translateX', closedX, openedX);
      const backdropAnimation = new AnimationC().addElement(menu.backdropEl).fromTo('opacity', 0.01, 0.32);
    ...
    const menuPushAnimation = (AnimationC, _, menu) => {
      ...
      const menuAnimation = new AnimationC().addElement(menu.menuInnerEl).fromTo('translateX', menuClosedX, '0px');
      const contentAnimation = new AnimationC().addElement(menu.contentEl).fromTo('translateX', '0px', contentOpenedX);
      const backdropAnimation = new AnimationC().addElement(menu.backdropEl).fromTo('opacity', 0.01, 0.32);
      return baseAnimation(AnimationC).then(animation => {
    ...
    const menuRevealAnimation = (AnimationC, _, menu) => {
      ...
      const contentOpen = new AnimationC().addElement(menu.contentEl).fromTo('translateX', '0px', openedX);
      return baseAnimation(AnimationC).then(animation => {
    ...
    class MenuController {
      ...
      _setActiveMenu(menu) {
        ...
        this.menus.filter(m => m.side === side && m !== menu).forEach(m => m.disabled = true);
      }
      ...
      async _createAnimation(type, menuCmp) {
        ...
        const animation = await __webpack_require__.e(
        /*! import() | index-d9adb105-js */
        "index-d9adb105-js").then(__webpack_require__.bind(null,
        /*! ./index-d9adb105.js */
        "./node_modules/@ionic/core/dist/esm/index-d9adb105.js")).then(mod => mod.create(animationBuilder, null, menuCmp));
