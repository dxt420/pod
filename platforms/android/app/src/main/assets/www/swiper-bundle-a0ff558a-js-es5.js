(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["swiper-bundle-a0ff558a-js"], {
  ...
  /***/
  function node_modulesIonicCoreDistEsmSwiperBundleA0ff558aJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function onTouchStart(event) {
      ...
      if (e.type !== 'touchstart') {
        ...
        if (doc.activeElement && $(doc.activeElement).is(data$$1.formElements) && doc.activeElement !== e.target) {
    ...
    function onTouchEnd(event) {
      ...
      const timeDiff = touchEndTime - data$$1.touchStartTime; // Tap, doubleTap, Click
...
//# sourceMappingURL=swiper-bundle-a0ff558a-js-es5.js.map