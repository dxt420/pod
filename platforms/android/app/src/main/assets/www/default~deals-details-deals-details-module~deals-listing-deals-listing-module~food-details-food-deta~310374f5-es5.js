(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~deals-details-deals-details-module~deals-listing-deals-listing-module~food-details-food-deta~310374f5"], {
  ...
  function node_modulesAngularPipesFesm2015AngularPipesJs(module, __webpack_exports__, __webpack_require__) {
    ...
    function createRound(method) {
      ...
      return function (value, precision = 0) {
        ...
        if (precision) {
          let pair = "".concat(value, "e").split('e');
          const val = func("".concat(pair[0], "e") + (+pair[1] + precision));
    ...
    let OrderByPipe = OrderByPipe_1 = class OrderByPipe {
      ...
      transform(input, config = '+') {
        ...
        const configIsArray = isArray(config); // If config === 'param' OR ['param'] 
    ...
    let UnionPipe = class UnionPipe {
      transform(a, b) {
        ...
        if (isDeepObject(a)) {
          ...
          return [].concat(unwrapped).concat(b).filter((value, index, input) => deepIndexOf(input, value) === index);
        }
    ...
    let CapitalizePipe = class CapitalizePipe {
      transform(input, all = false) {
        ...
        if (!all) {
          ...
          return input.toLowerCase().split(' ').map(value => upperFirst(value)).join(' ');
        }
      }
    ...
    let TemplatePipe = class TemplatePipe {
      transform(input, ...args) {
        ...
        for (let i = 0; i < args.length; ++i) {
          template = template.replace("$".concat(i + 1), args[i]);
        }
  ...
  function srcAppPipesTimeAgoPipeTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var dayjs_plugin_relativeTime__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_relativeTime__WEBPACK_IMPORTED_MODULE_3__); // When fixed, uncomment this
  ...
  function srcAppPipesTimeDifferencePipeTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var dayjs__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_2__); // When fixed, uncomment this
    // import * as dayjs from 'dayjs';
    // TODO:  dayjs is throiwing this ERROR:
    //        error TS2339: Property 'to' does not exist on type 'Dayjs'.
    // Luckily there is a PR which solves it (https://github.com/iamkun/dayjs/issues/297#issuecomment-442748858)
