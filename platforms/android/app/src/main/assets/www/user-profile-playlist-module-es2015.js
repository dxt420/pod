...
let PlaylistService = class PlaylistService {
    ...
    getPlaylistDataSource() {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this.nativeHttp.get('https://pod.pythonanywhere.com/api/playlists/?format=json', {}, {}))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(response => {
            console.log(response);
            console.log(response.data);
            // console.log(response.data.results); 
            return Object.assign(new _profile_playlist_model__WEBPACK_IMPORTED_MODULE_7__["PlaylistListingModel"](), response.data);
            // return ;
        }));
    }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PlaylistListingModel", function() { return PlaylistListingModel; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
PlaylistPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./playlist.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/user/profile/playlist.page.html")).default,
