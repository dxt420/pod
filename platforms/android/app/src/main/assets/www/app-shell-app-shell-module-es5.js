(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-shell-app-shell-module"], {
  ...
  /***/
  function srcAppShowcaseAppShellAppShellPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppShowcaseAppShellDataStoreBasicDataStoreBasicPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let DataStoreBasicPage = class DataStoreBasicPage {
      ...
      showcaseDataStore() {
        ...
        this.dataStoreButtonDisabled = true;
        const dataSource = this.showcaseService.getSimpleDataSource(); // Initialize the model specifying that it is a shell model

        const shellModel = new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_3__["ShowcaseShellModel"]();
        const dataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_5__["DataStore"](shellModel); // Trigger the loading mechanism (with shell) in the dataStore
  ...
  function srcAppShowcaseAppShellDataStoreCombinedDataStoreCombinedPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let DataStoreCombinedPage = class DataStoreCombinedPage {
      ...
      ngOnInit() {
        ...
        const shellModel = [new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseCombinedTaskUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseCombinedTaskUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseCombinedTaskUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseCombinedTaskUserModel"]()];
  ...
  function srcAppShowcaseAppShellDataStoreDependantDataStoreDependantPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let DataStoreDependantPage = class DataStoreDependantPage {
      ...
      ngOnInit() {
        ...
        const commentsShellModel = [new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_2__["ShowcaseCommentModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_2__["ShowcaseCommentModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_2__["ShowcaseCommentModel"]()];
  ...
  function srcAppShowcaseAppShellDataStoreListDataStoreListPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let DataStoreListPage = class DataStoreListPage {
      ...
      ngOnInit() {
        const dataSource = this.showcaseService.getListDataSource(); // Initialize the model specifying that it is a shell model

        const shellModel = [new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_3__["ShowcaseShellUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_3__["ShowcaseShellUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_3__["ShowcaseShellUserModel"]()];
    ...
    let DataStorePaginationPage = class DataStorePaginationPage {
      ...
      ngOnInit() {
        ...
        if (!this.remoteApiDataStore) {
          ...
          const shellModel = [new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseShellUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseShellUserModel"]()];
        ...
        const newDataObservable = this.newPageTriggerObservable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(pageNumber => {
          ...
          const newDataShell = [new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseShellUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseShellUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_4__["ShowcaseShellUserModel"]()];
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(this.remoteApiDataStore.state, newDataObservable).subscribe(result => {
    ...
    let DataStoreStackedPage = class DataStoreStackedPage {
      ...
      ngOnInit() {
        ...
        const newDataObservable = this.newItemsTriggerObservable.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(() => {
          ...
          const newDataShell = [new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_3__["ShowcaseShellUserModel"](), new _showcase_shell_model__WEBPACK_IMPORTED_MODULE_3__["ShowcaseShellUserModel"]()];
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["merge"])(this.openDataStore.state, newDataObservable).subscribe(data => {
  ...
  function srcAppShowcaseAppShellSimpleDataBindingSimpleDataBindingPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let SimpleDataBindingPage = class SimpleDataBindingPage {
      ...
      showcaseShellSimpleFetch(countdown) {
        ...
        const timer$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["timer"])(countdown * 1000); // When timer emits after X seconds, complete source

        this.simpleFetchInterval.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["takeUntil"])(timer$), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["finalize"])(() => this.simpleFetchButtonDisabled = false)).subscribe({
          next: () => {
            this.simpleFetchCountdown--;
          },
          complete: () => {
            this.simpleFetchCountdown = 0; // Once the countdown ends, fetch data using the HttpClient

            this.showcaseService.getSimpleDataSource().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1) // Force Observable to complete
            ).subscribe(val => {
