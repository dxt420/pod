(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  function node_modulesIonicCoreDistEsmChunk3c9755ddJs(module, __webpack_exports__, __webpack_require__) {
    ...
    const getAnimationBuilder = async opts => {
      ...
      const builder = opts.mode === 'ios' ? (await iosTransitionAnimation()).iosTransitionAnimation : (await mdTransitionAnimation()).mdTransitionAnimation;
      return builder;
    };

    const animation = async (animationBuilder, opts) => {
      await waitForReady(opts, true);
      const trans = await __webpack_require__.e(
      /*! import() | index-d9adb105-js */
      "index-d9adb105-js").then(__webpack_require__.bind(null,
      /*! ./index-d9adb105.js */
      "./node_modules/@ionic/core/dist/esm/index-d9adb105.js")).then(mod => mod.create(animationBuilder, opts.baseEl, opts));
  ...
  function srcAppDealsDetailsDealsDetailsModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    class DealsDetailsModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_2__["ShellModel"] {
      constructor() {
        super();
        this.showcaseImages = ['', '', '']; // Default mock value
  ...
  function srcAppDealsListingDealsListingModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    class DealsListingModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_2__["ShellModel"] {
      constructor() {
        super();
        this.items = [new DealsItemModel(), new DealsItemModel(), new DealsItemModel(), new DealsItemModel()];
      }
  ...
  function srcAppFashionFashionServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let FashionService = class FashionService {
      ...
      getListingDataSource() {
        return this.http.get('./assets/sample-data/fashion/listing.json'); // return this.http.get<FashionListingModel>('http://pod.pythonanywhere.com/api/artistsongs/'+artist_alias+'/');
      }
  ...
  function srcAppFoodFoodServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let FoodService = class FoodService {
      ...
      getDetailsDataSource(slug) {
        return this.http.get('./assets/sample-data/food/details.json').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["flatMap"])(details => details.items.filter(item => item.slug === slug)));
      }
  ...
  function srcAppNotificationsNotificationsResolverTs(module, __webpack_exports__, __webpack_require__) {
    ...
    NotificationsResolver = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_notifications_service__WEBPACK_IMPORTED_MODULE_2__["NotificationsService"]])], NotificationsResolver);
    /***/
  },
  ...
  function srcAppRealStateDetailsRealStateDetailsModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    class RealStateDetailsModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_1__["ShellModel"] {
      constructor() {
        super();
        this.amenities = [{
          name: '',
  ...
  function srcAppRealStateListingRealStateListingModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    class RealStateListingModel extends _shell_data_store__WEBPACK_IMPORTED_MODULE_1__["ShellModel"] {
      constructor() {
        super();
        this.items = [new RealStateItemModel(), new RealStateItemModel(), new RealStateItemModel(), new RealStateItemModel()];
      }
  ...
  function srcAppRealStateRealStateServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let RealStateService = class RealStateService {
      constructor(http) {
        this.http = http;
      }
      ...
      getListingStore(dataSource) {
        ...
        if (!this.listingDataStore) {
          // Initialize the model specifying that it is a shell model
          const shellModel = new _listing_real_state_listing_model__WEBPACK_IMPORTED_MODULE_3__["RealStateListingModel"]();
          this.listingDataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_5__["DataStore"](shellModel); // Trigger the loading mechanism (with shell) in the dataStore
      ...
      getDetailsStore(dataSource) {
        ...
        if (!this.detailsDataStore) {
          // Initialize the model specifying that it is a shell model
          const shellModel = new _details_real_state_details_model__WEBPACK_IMPORTED_MODULE_4__["RealStateDetailsModel"]();
          this.detailsDataStore = new _shell_data_store__WEBPACK_IMPORTED_MODULE_5__["DataStore"](shellModel); // Trigger the loading mechanism (with shell) in the dataStore
    ...
    RealStateService.ctorParameters = () => [{
      type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
    }];
      ...
      getCombinedTasksUserDataSource() {
        return this.getTasks().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["concatMap"])(tasks => {
          const completeTaskData = tasks.map(task => {
            ...
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])([Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])(task), taskUser]).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(([taskData, user]) => {
  ...
  function srcAppTravelTravelServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    let TravelService = class TravelService {
      ...
      getListingDataSource() {
        console.log(this.http.get('./assets/sample-data/travel/listing.json'));
        return this.http.get('./assets/sample-data/travel/listing.json');
      }
